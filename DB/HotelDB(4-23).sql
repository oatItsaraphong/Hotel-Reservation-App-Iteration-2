...
--
-- Host: localhost
-- Generation Time: Apr 23, 2017 at 09:49 PM
...
(0, 'Admin', 'Minion', NULL, '112233', 4),
(1044, 'executive', 'prime ', NULL, '112233', 3),
(1122, 'PGFamilyGuy', 'Peter Griffin', NULL, '123456', 2),
...
(1151, 'Vegae', 'Jonatahn Boo', NULL, '123456', 2),
(1153, 'Shining', 'Here Johnny', NULL, '12345', 2),
(1154, 'mandy', 'mandy he', NULL, '123', 2),
(1156, 'golf', 'Gofman', NULL, '123', 2);
...
--
-- Table structure for table `MaintenanceTable`
--

CREATE TABLE `MaintenanceTable` (
  `MainID` int(10) UNSIGNED NOT NULL,
  `MainType` tinytext COLLATE utf8_general_mysql500_ci NOT NULL,
  `MainCost` float NOT NULL,
  `StartDate` date NOT NULL,
  `EndDate` date NOT NULL,
  `MainDetail` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL,
  `RoomToFix` smallint(5) UNSIGNED NOT NULL,
  `ActiveStatus` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;

--
-- Dumping data for table `MaintenanceTable`
--

INSERT INTO `MaintenanceTable` (`MainID`, `MainType`, `MainCost`, `StartDate`, `EndDate`, `MainDetail`, `RoomToFix`, `ActiveStatus`) VALUES
(100, 'Fix', 200, '2017-04-14', '2017-04-15', 'new tap', 202, 0),
(101, 'Fix', 500, '2017-04-23', '2017-04-26', 'Need to replace a TV', 202, 0),
(102, 'Remodel', 1800, '2017-04-03', '2017-04-08', 'Redo the carpet and window', 401, 0),
(134, 'required', 496, '2017-04-12', '2017-04-30', 'Unknown', 401, 0),
(135, 'Replacement', 600, '2017-04-23', '2017-04-23', 'Need new TV', 301, 1),
(141, 'Unknown', 0, '2017-04-23', '2017-04-23', 'Unknown', 402, 1),
(360, 'required', 0, '2017-04-23', '2017-04-23', 'Unknown', 401, 0),
(362, 'Unknown', 0, '2017-04-23', '2017-04-23', 'Unknown', 401, 1);
...
(1056, '2017-04-23', '2017-04-26', 204, 18, 2, '0', 'None', 'Check In', 0, 0, 0, 'nto'),
(1057, '2017-04-23', '2017-04-26', 301, 19, 2, '0', 'None', 'Reserved', 0, 0, 0, '32'),
(1058, '2017-04-26', '2017-04-29', 303, 35, 2, '0', 'None', 'Reserved', 0, 0, 0, 'ni');
...
(31, 1056, '2017-04-07', '2017-04-08', 202, 32, 3, '0', 'None', 'Cancel', 0, 0, 0, '123'),
(32, 1057, '2017-04-11', '2017-04-13', 201, 36, 2, '0', 'None', 'Cancel', 0, 0, 0, 'none'),
(33, 1058, '2017-04-11', '2017-04-13', 204, 36, 3, '0', 'None', 'Cancel', 0, 0, 0, '1'),
(34, 1059, '2017-04-11', '2017-04-13', 202, 17, 2, '0', 'None', 'Cancel', 0, 0, 0, '');
...
INSERT INTO `RoomTable` (`RoomIDNum`, `RoomPrice`, `NumberOfBed`, `RoomStatus`, `BedType`, `LocationType`, `Kitchen`, `Balcony`, `Special`) VALUES
(201, 1200, 2, 'Good', 'Twin', 'Sky', 0, 1, ''),
(202, 1200, 2, 'Good', 'Full Beds', 'Garden View', 0, 1, NULL),
(203, 1200, 1, 'Good', 'King Bed', 'City View', 1, 1, NULL),
(204, 1200, 1, 'Good', 'California King', 'City', 1, 1, ''),
(301, 1200, 2, 'Fix', 'Twin Beds', 'City View', 0, 0, NULL),
(302, 1200, 1, 'Good', 'King Bed', 'Garden View', 0, 0, NULL),
(303, 1200, 1, 'Good', 'Queen Bed', 'Garden View', 0, 0, NULL),
(304, 1500, 1, 'Good', 'Calfornia King', 'City View', 1, 1, 'Personal pool'),
(401, 1200, 3, 'Fix', 'Twin Beds', 'Lake view', 1, 0, 'smoking'),
(402, 100, 2, 'Fix', 'King', 'Lake', 0, 1, 'No Smoking');
...
--
-- Indexes for table `MaintenanceTable`
--
...
--
-- AUTO_INCREMENT for table `MaintenanceTable`
--
ALTER TABLE `MaintenanceTable`
  MODIFY `MainID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=363;
--
-- AUTO_INCREMENT for table `ReservationTable`
--
ALTER TABLE `ReservationTable`
  MODIFY `ReservationID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1059;
--
-- AUTO_INCREMENT for table `ResevHistoryTable`
--
ALTER TABLE `ResevHistoryTable`
  MODIFY `ResevHisID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `RoomTable`
--
ALTER TABLE `RoomTable`
  MODIFY `RoomIDNum` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=403;
--
